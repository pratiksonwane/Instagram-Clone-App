  ...
  return (
    <div style={{borderRadius:25,border:'1px solid grey',marginTop:-20}}>
        ...
        <div className="ctQZ">   
            ...
            <div className="ctQZ">   
            <div className="_47KiJ">
                <button style={{marginTop : -19, marginRight:50,fontWeight : 200, blockSize : 30,background:'skyblue'}} onClick={this.change}> {this.state.follow}</button>
                <button style={{marginTop : -19,marginRight:70, fontWeight : 200, blockSize : 30,background:'skyblue'}}> Message</button>
                </div>
            </div>
